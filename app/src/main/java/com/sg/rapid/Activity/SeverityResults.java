...
public class SeverityResults extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    private void showResults(final Context mContext, OccuranceRequest data){
        ...
        OccuranceService.getSeverityResults(data, new ResponseListner() {
            @Override
