...
public class FilteredAlarms  extends AppCompatActivity  implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.filtered_alarms);

        navigationfilteredalarms = findViewById(R.id.navigationfilteredalarms);
            ...
            switch (v.getId()) {
                ...
                case R.id.enddate:
                    if (startdate.getText().toString() != "") {
                        ...
                        Toast.makeText(FilteredAlarms.this, "Please select start date", Toast.LENGTH_LONG).show();
                    }
                    break;
    ...
    private void onClickofViewButton(){
        if(selectedsubsys.equalsIgnoreCase("0")){
            Toast.makeText(FilteredAlarms.this,"Please select subsystem",Toast.LENGTH_LONG).show();
            return;
        }

        if(selectedseverity.equalsIgnoreCase("")){
            Toast.makeText(FilteredAlarms.this,"Please select severity",Toast.LENGTH_LONG).show();
            return;
        }

        if(selectedrange.equalsIgnoreCase("Select Range")){
            Toast.makeText(FilteredAlarms.this,"Please select daterange",Toast.LENGTH_LONG).show();
            return;
        ...
        Intent mResults = new Intent(FilteredAlarms.this,FilteredResult.class) ;
    ...
    private void loadRangeSpinner(){
        ...
        rangeAdapter = new RangeAdapter(FilteredAlarms.this,rangedata);
