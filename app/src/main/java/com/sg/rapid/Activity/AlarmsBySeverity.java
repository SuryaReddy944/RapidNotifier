...
public class AlarmsBySeverity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alarmsbyseverity);

        navigationfilteredalarms = findViewById(R.id.navigationalarmbyseverity);
            ...
            switch (v.getId()) {
                ...
                case R.id.enddate:
                    if (startdate.getText().toString() != "") {
                        ...
                        Toast.makeText(AlarmsBySeverity.this, "Please select start date", Toast.LENGTH_LONG).show();
                    }
                    break;
    ...
    private void onClickofViewButton(){
        ...
        if(selectedseverity.equalsIgnoreCase("")){
            Toast.makeText(AlarmsBySeverity.this,"Please select severity",Toast.LENGTH_LONG).show();
            return;
        }

        if(selectedrange.equalsIgnoreCase("Select Range")){
            Toast.makeText(AlarmsBySeverity.this,"Please select daterange",Toast.LENGTH_LONG).show();
            return;
        ...
        Intent mResults = new Intent(AlarmsBySeverity.this,SeverityResults.class) ;
    ...
    private void loadRangeSpinner(){
        ...
        rangeAdapter = new RangeAdapter(AlarmsBySeverity.this,rangedata);
