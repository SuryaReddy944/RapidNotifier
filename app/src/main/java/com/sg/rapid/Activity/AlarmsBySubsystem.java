...
public class AlarmsBySubsystem extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alarmsby_subsystem);

        navigationfilteredalarms = findViewById(R.id.navigationalarmbysubsystem);
            ...
            switch (v.getId()) {
                ...
                case R.id.enddate:
                    if (startdate.getText().toString() != "") {
                        ...
                        Toast.makeText(AlarmsBySubsystem.this, "Please select start date", Toast.LENGTH_LONG).show();
                    }
                    break;
    ...
    private void onClickofViewButton(){
        if(selectedsubsys.equalsIgnoreCase("0")){
            Toast.makeText(AlarmsBySubsystem.this,"Please select subsystem",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        if(selectedrange.equalsIgnoreCase("Select Range")){
            Toast.makeText(AlarmsBySubsystem.this,"Please select daterange",Toast.LENGTH_LONG).show();
            return;
        ...
        Intent mResults = new Intent(AlarmsBySubsystem.this,SubsystemResults.class) ;
    ...
    private void loadRangeSpinner(){
        ...
        rangeAdapter = new RangeAdapter(AlarmsBySubsystem.this,rangedata);
