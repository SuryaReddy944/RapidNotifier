...
public class AlaramDetailedPage extends AppCompatActivity  implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(alaramResponse.getAPriority().equalsIgnoreCase("High")){
            lblstatus.setBackgroundResource(R.drawable.fullcircle_red);
            lblpriority.setText("High priority");
        }else if(alaramResponse.getAPriority().equalsIgnoreCase("Normal")){
            lblstatus.setBackgroundResource(R.drawable.fullcircle_green);
            lblpriority.setText("Normal priority");
        }else if(alaramResponse.getAPriority().equalsIgnoreCase("Low")){
            lblstatus.setBackgroundResource(R.drawable.fullcircle_yello);
            lblpriority.setText("Low priority");
        }else if(alaramResponse.getAPriority().equalsIgnoreCase("Medium")){
            lblstatus.setBackgroundResource(R.drawable.fullcircle_orange);
            lblpriority.setText("Medium priority");
        }else{
            lblstatus.setBackgroundResource(R.drawable.fullcircle_green);
        }
        mAlaramName.setText("Asset : " +alaramResponse.getAssetName());
        mAlaramType.setText("Subsystem : " +alaramResponse.getAssetType());
        mDescription.setText("Description : " +alaramResponse.getFaultDecription());
        mCreateddate.setText("Alarm date/time : " + DateUtils.getDay(alaramResponse.getCreateDate())+" "+DateUtils.getTime(alaramResponse.getCreateDate()));

        String note = (String) alaramResponse.getAcknowledgeNotes();
        if(note != null){
            mAckNotesBy.setText("Acknowledgement By : " + alaramResponse.getUserName());
            ackdateandtime.setText("Acknowledgement On : " + DateUtils.getDay((String) alaramResponse.getAcknowledgedOn())+" "+DateUtils.getTime(alaramResponse.getCreateDate()));
