...
public class SubsystemResults extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{

    public BottomNavigationView navigationoccuranceresults;
    private RecyclerView mReportsData;
    private TextView mNodata;
    private SeverityReportAdapter mAdapter;
    ...
    private void showResults(final Context mContext, OccuranceRequest data){
        ...
        OccuranceService.getSubsystemResults(data, new ResponseListner() {
            @Override
            public void onSucess(Object response, int sttuscode) {
                ...
                if(mLsit.size() >0){
                    ...
                    mAdapter = new SeverityReportAdapter(mContext,mLsit);
